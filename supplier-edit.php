...
//ambil id
$id = $_GET["id"];
$data_supplier = query("SELECT * FROM tblsupplier WHERE idsupplier=$id");
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Supplier</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-block">
                                <form method="post" action="" enctype="multipart/form-data" class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="hidden" name="idsupplier" value="<?= $data_supplier[0]['idsupplier']?>">  
                                            <input type="text" name="nama" placeholder="ex. Joko Widodo" value="<?=  $data_supplier['0']['nama']?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Alamat</label>
                                        <div class="col-md-12">
                                            <input type="text" name="alamat" placeholder="ex. Bangkalan" value="<?=  $data_supplier['0']['alamat']?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Nomor Telepon</label>
                                        <div class="col-md-12">
                                            <input type="number" name="notelp" placeholder="ex. 081234567890" value="<?=  $data_supplier['0']['notelp']?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="text" name="email" placeholder="ex. 081234567890" value="<?=  $data_supplier['0']['email']?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
