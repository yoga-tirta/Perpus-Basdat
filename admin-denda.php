            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Daftar Denda</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">List Denda</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <?php $data_cari = query("SELECT tbltransaksi.*, tbluser.nama FROM tbltransaksi INNER JOIN tbluser ON tbltransaksi.iduser = tbluser.iduser WHERE tbltransaksi.status = 'denda' OR tbltransaksi.status = 'lunas' "); ?>
                                        <?php $angka = 1; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row['pembayaran'] == 0) : ?>
                                                        <a class="btn btn-info" href="bayar-denda.php?idtransaksi=<?= $row['idtransaksi']?>">Bayar</a>
                                                    <?php else: ?>
                                                        <button class="btn btn-info" disabled href="bayar-denda.php?idtransaksi=<?= $row['idtransaksi']?>">Bayar</button>
                                                    <?php endif; ?>
