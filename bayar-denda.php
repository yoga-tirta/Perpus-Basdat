            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li> <a class="waves-effect waves-dark" href="index.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                        ...
                        <li> <a class="waves-effect waves-dark" href="admin-kembali.php" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Pengembalian</span></a></li></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Bayar Denda</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <?php $data_cari = query("SELECT tbltransaksi.*, tbluser.nama FROM tbltransaksi INNER JOIN tbluser ON tbltransaksi.iduser = tbluser.iduser WHERE tbltransaksi.idtransaksi = '$_GET[idtransaksi]' "); ?>                                        
                                <?php foreach($data_cari as $row): ?>
                                    <form method="post" action="function_admin.php?act=bayardenda" enctype="multipart/form-data" class="form-horizontal form-material">
                                    <input type="hidden" name="idtransaksi" value="<?= $row['idtransaksi'] ?>">                                    
                                    <input type="hidden" name="total" value="<?= $row['jumlah_denda'] ?>">

                                        <div class="form-group">
                                            <label class="col-md-12">Nama</label>
                                            <div class="col-md-12">
                                                <input type="text" name="nama" placeholder="Nama" class="form-control form-control-line" disabled value="<?= $row['nama'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Denda</label>
                                            <div class="col-md-12">
                                                <input type="text" name="denda" placeholder="Denda" class="form-control form-control-line" disabled value="<?= $row['jumlah_denda'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Pembayaran</label>
                                            <div class="col-md-12">
                                                <input type="number" name="pembayaran" placeholder="0" class="form-control form-control-line" min="0">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button name="submit" class="btn btn-success">Bayar</button>
                                            </div>
                                        </div>
                                    </form>                                            
                                <?php endforeach;?>                                    
